...
def start_output(output: list, nnodes: int) -> None:
    ...
    output.append("  </head>\n")
    output.append("  <body>\n")
    output.append("    <h1>Taxonomic Key</h1>\n")
    output.append("    <div class=\"key_intro\">This key was auto-generated by "
                  "<span class=\"tkg_title\">TaxKeyGen</span> "
                  "(<a href=\"https://github.com/msrosenberg/TaxKeyGen\">https://github.com/msrosenberg/TaxKeyGen</a>)"
                  "</div>")
